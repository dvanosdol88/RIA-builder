...
import { ChevronRight, Clock, AlertCircle, CheckCircle2, Circle } from 'lucide-react';
...
function ThreeStateToggle({ status, onChange, disabled = false }: ThreeStateToggleProps) {
  const statusColors = {
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <span className={`text-[10px] font-medium ${
        status === 'not_started' ? 'text-red-600' :
    ...
    items: [
      {
        ...
        timeframe: 'Week 1-2',
        details: 'Form LLC or corporation in your state. Consider single-member LLC for solo practice.',
      },
      {
        id: 'ein-application',
        ...
        details: 'Free online application at IRS.gov. Required for bank accounts and filings.',
      },
      {
        id: 'state-sec-decision',
        text: 'State vs SEC registration decision',
        timeframe: 'Week 2-3',
        details: 'Under $100M AUM = state registration. Flat-fee model with ~500 clients likely qualifies for state.',
      },
      {
        id: 'adv-part1-prep',
        ...
        details: 'Filed through IARD system. Discloses business practices, fees, disciplinary history.',
      },
      {
        ...
        details: 'Plain-English disclosure document for clients. Must be delivered before or at contract signing.',
      },
      {
        id: 'eo-insurance',
        text: 'E&O/Professional Liability Insurance',
        timeframe: 'Week 4-6',
        details: 'Typical coverage: $1M per occurrence. Shop multiple carriers. Required by most states.',
      },
      {
        ...
        details: 'Investment Adviser Registration Depository. State registration fees vary ($100-$600).',
      },
      {
        ...
        details: 'Required if advising clients in multiple states. Additional fees per state.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        timeframe: 'Week 3-4',
        details: 'Configure workflows, custom fields, tags. Import contacts. Set up integrations.',
      },
      {
        id: 'planning-rightcapital',
        text: 'Planning software (RightCapital)',
        timeframe: 'Week 3-4',
        details: 'Configure planning assumptions, branding, client portal settings.',
      },
      {
        ...
        details: 'Connect Plaid for automatic account linking. Test with multiple institution types.',
      },
      {
        id: 'manual-upload-flow',
        text: 'Manual statement upload workflow',
        timeframe: 'Week 4-5',
        details: 'Design fallback process for institutions not supported by Plaid.',
      },
      {
        id: 'email-archiving',
        text: 'WORM-compliant email archiving',
        timeframe: 'Week 4-6',
        details: 'Required by SEC/state regulations. Options: Smarsh, Global Relay, or built-in Microsoft 365.',
      },
      {
        id: 'website-deployment',
        text: 'Website deployment',
        timeframe: 'Week 5-7',
        details: 'Ensure ADV-compliant disclosures, clear fee information, required regulatory disclaimers.',
      },
      {
        id: 'fee-calculator',
        ...
        details: 'Transparent $100/month flat fee calculator. Test edge cases and mobile responsiveness.',
      },
      {
        id: 'client-portal',
        ...
        timeframe: 'Week 5-7',
        dependencies: 'Planning software',
        details: 'RightCapital client portal setup. Test document sharing, task assignment.',
      },
      {
        id: 'calendar-scheduling',
        text: 'Calendar and scheduling tool',
        timeframe: 'Week 4-5',
        details: 'Calendly or built-in CRM scheduling. Configure meeting types, buffers, availability.',
      },
      {
        id: 'video-conferencing',
        text: 'Video conferencing setup',
        timeframe: 'Week 3-4',
        details: 'Zoom or Google Meet. Test screen sharing, recording for compliance.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        timeframe: 'Week 4-7',
        details: 'Required by Rule 206(4)-7. Cover trading, custody, privacy, advertising, etc.',
      },
      {
        id: 'code-of-ethics',
        text: 'Code of Ethics',
        timeframe: 'Week 4-6',
        details: 'Required by Rule 204A-1. Personal trading policies, gift rules, confidentiality.',
      },
      {
        id: 'privacy-policy',
        text: 'Privacy Policy (Reg S-P)',
        timeframe: 'Week 4-6',
        details: 'Initial and annual privacy notices. Document information sharing practices.',
      },
      {
        id: 'advertising-review',
        text: 'Advertising Review Process',
        timeframe: 'Week 5-7',
        details: 'Document approval process for all marketing. Maintain advertising file.',
      },
      {
        id: 'client-agreement',
        ...
        details: 'Define scope of services, fees ($100/month), termination, fiduciary duty.',
      },
      {
        id: 'aml-procedures',
        text: 'AML/KYC Procedures',
        timeframe: 'Week 5-7',
        details: 'Client identification, suspicious activity monitoring. Required for non-custodial advisors too.',
      },
      {
        id: 'business-continuity',
        text: 'Business Continuity Plan',
        timeframe: 'Week 6-8',
        details: 'Document backup systems, succession planning, disaster recovery procedures.',
      },
      {
        id: 'cybersecurity-policy',
        text: 'Cybersecurity Policy',
        timeframe: 'Week 5-7',
        details: 'Required by many states. Password policies, data encryption, incident response.',
      },
      {
        id: 'books-records',
        text: 'Books and Records Procedures',
        timeframe: 'Week 5-7',
        details: 'Rule 204-2 compliance. Document retention schedule (5-6 years minimum).',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        timeframe: 'Week 2-4',
        details: 'Logo, colors, fonts. Ensure professional but approachable for target audience.',
      },
      {
        id: 'website-live',
        ...
        details: 'All pages reviewed for compliance. ADV brochure accessible. Fee transparency.',
      },
      {
        ...
        details: 'Test all scenarios. Clear $100/month messaging. No hidden fee implications.',
      },
      {
        id: 'postcard-campaign',
        text: 'Postcard campaign designed and printed',
        timeframe: 'Week 8-10',
        details: 'Compliance-reviewed. Target geographic area. Track response codes.',
      },
      {
        id: 'social-linkedin',
        text: 'LinkedIn profile optimized',
        timeframe: 'Week 6-8',
        details: 'Professional photo, clear value proposition, link to website.',
      },
      {
        id: 'social-profiles',
      ...
      },
      {
        ...
        timeframe: 'Week 8-10',
        details: 'Educational content aligned with target audience. Pre-approved topics.',
      },
      {
        id: 'referral-strategy',
        text: 'Referral strategy documented',
        timeframe: 'Week 9-11',
        details: 'No cash referral fees without disclosure. Thank-you process for referrers.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        details: 'Complete full client journey: onboarding, aggregation, first meeting, plan delivery.',
      },
      {
        id: 'error-handling',
        text: 'Error handling protocols documented',
        timeframe: 'Week 10-11',
        details: 'What happens when Plaid fails? Manual upload process. Client communication templates.',
      },
      {
        id: 'soft-launch-criteria',
        text: 'Soft launch criteria defined',
        timeframe: 'Week 10-11',
        details: 'Identify 3-5 beta clients. Friends/family or warm contacts. Gather feedback.',
      },
      {
        ...
        details: 'Onboard beta clients. Document friction points. Iterate on process.',
      },
      {
        id: 'day1-checklist',
        text: 'Day 1 operational checklist',
        timeframe: 'Week 12',
        details: 'Morning routine, system checks, response time goals, escalation procedures.',
      },
      {
        id: 'support-procedures',
        text: 'Client support procedures',
        timeframe: 'Week 11-12',
        details: 'How to handle questions, complaints, urgent requests. Response time SLAs.',
      },
      {
        id: 'ai-assistant-trained',
        text: 'AI assistant prompts and guardrails',
        timeframe: 'Week 10-12',
        details: 'Document AI usage policies. Human review requirements. Disclosure to clients.',
      },
      {
        ...
        details: 'Email to network, social posts, press release if appropriate.',
      },
      {
        id: 'week1-goals',
        text: 'Week 1 success metrics defined',
        timeframe: 'Week 12',
        details: 'Number of inquiries, consultations booked, clients onboarded. Realistic expectations.',
      },
      {
        id: 'backup-plans',
        text: 'Backup plans for common failures',
        timeframe: 'Week 11-12',
        details: 'Plaid outage, scheduling conflicts, document signing failures. Workarounds documented.',
      },
    ],
  },
];
...
export default function PreLaunchChecklistView() {
  ...
  const [checklistStates, setChecklistStates] = useState<Record<string, ChecklistStatus>>({});
  ...
  const currentPage = CHECKLIST_PAGES.find((p) => p.id === activePage) || CHECKLIST_PAGES[0];
  ...
  const getPageProgress = (pageId: string) => {
    ...
    const complete = page.items.filter((item) => checklistStates[item.id] === 'complete').length;
    const inProgress = page.items.filter((item) => checklistStates[item.id] === 'in_progress').length;
  ...
  const getOverallProgress = () => {
    ...
    const complete = allItems.filter((item) => checklistStates[item.id] === 'complete').length;
    const inProgress = allItems.filter((item) => checklistStates[item.id] === 'in_progress').length;
    ...
    <div className="flex h-full overflow-hidden gap-4">
      ...
      <div className="w-52 bg-white border-r border-gray-200 overflow-y-auto pr-2">
        <div className="p-4 border-b border-gray-200">
          <h2 className="text-lg font-bold text-slate-900">Pre-Launch Checklist</h2>
          ...
          <div className="mt-4">
            <div className="flex justify-between text-xs text-gray-600 mb-1">
              ...
              <span>{Math.round((overall.complete / overall.total) * 100)}%</span>
            </div>
            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
              <div
                className="h-full bg-green-500 transition-all duration-300"
                style={{ width: `${(overall.complete / overall.total) * 100}%` }}
              />
            </div>
            <div className="flex justify-between text-[10px] text-gray-400 mt-1">
              <span>{overall.complete} complete</span>
              <span>{overall.inProgress} in progress</span>
              <span>{overall.total - overall.complete - overall.inProgress} remaining</span>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  {progress.total - progress.complete - progress.inProgress > 0 && (
                    <span className="text-[10px] text-gray-400 flex items-center gap-0.5">
                      <Circle size={10} /> {progress.total - progress.complete - progress.inProgress}
                    </span>
                  )}
                </div>
              </button>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-3xl">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-4">
                          <h3 className={`font-medium ${
                            status === 'complete' ? 'text-green-700 line-through' : 'text-gray-900'
                          }`}>
                            {item.text}
                          </h3>
          ...
          <div className="mt-8 flex justify-between">
            <button
              onClick={() => {
                const currentIndex = CHECKLIST_PAGES.findIndex((p) => p.id === activePage);
                if (currentIndex > 0) {
                  setActivePage(CHECKLIST_PAGES[currentIndex - 1].id);
                }
              }}
              disabled={CHECKLIST_PAGES.findIndex((p) => p.id === activePage) === 0}
            ...
            <button
              ...
              disabled={CHECKLIST_PAGES.findIndex((p) => p.id === activePage) === CHECKLIST_PAGES.length - 1}
